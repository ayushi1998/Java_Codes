...
//    }
//
//    public Game2(Player[] p, int np, int g, Stage ps)
//    {
//        players=p;
//        finished=false;
//        num_players=np;
...
//
//
//                        Gamedata gamedata=new Gamedata(players,count,G,finished,grid_size,tiles,num_players);
...
//                    break;
//                case 2:alert.setContentText("Player 2 won!");
//                    break;
...
//
//
//        public UltuGameData(Player[] array, int count, Grid grid,int grid_size,Cell[][] tiles,Stage primarystage,int num_players) throws Exception 
//        {
//            this.array = array;
//            this.count = count;
//            this.grid = grid;
...
//    int num_players;
//
//    public Gamedata(Player[] array, int count, Grid g, boolean finished,int grid_size, Cell[][] tiles,int num_players)
//    {
//        this.array = array;
//        this.count = count;
//        this.g = g;
